...
public class JwtUtils {
	...
	@Value("${fiordex.jwt.secret}")
	private String jwtSecret;
	
	@Value("${fiordex.jwt.expiration}")
	...
	public void setHeaderData(String jwt, HttpServletResponse res ) {
		res.setHeader(HEADER_NAME, TOKEN_TYPE+jwt);
	}
